...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  // TODO: Write your code here
  var outputOne = sum(a,b)[0];
  outputOne = sum(outputOne,c)[0];
  var outputTwo = multiply(a, b)[0];
  outputTwo = multiply(outputTwo, c)[0];
...
function sumArray(testArray) { //eslint-disable-line
  ...
  var message = `${testArray} was passed in as an array of numbers, and ${output} is their sum.`;
  return [output, message];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var message = `The numbers ${testArray} have a product of ${output}.`;
  return [output, message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  // Set output to 1 so first number is multiplied by 1 (in case of 1 element array)
  var output = 1;
  for (var i = 0; i < dynamicArray.length; i++) {
    output = multiply(output, testDynamicArray[i])[0];
    // console.log(`${i}: ${output}`);
  }
  var message = `The numbers ${testDynamicArray} have a product of ${output}.`;
  return [output, message];
}
